    ...
    <div className="flex-1 w-full flex items-center justify-center">
      <div className="bg-white w-10/12 max-w-xs rounded-2xl h-auto shadow">
        <div className="bg-card-bg bg-no-repeat bg-cover h-32 w-full rounded-t-2xl relative">
          <img
            className="border-solid border-5 border-white rounded-full absolute left-1/2 -bottom-1/2 transform -translate-x-1/2 -translate-y-1/4"
            width="96"
            height="96"
            src={victor}
            alt="User profile"
        ...
        <div className="text-center pt-14 pb-6">
          <div className="mb-2.5">
            <h1>
              <span className="font-bold tracking-wide antialiased text-blue-desat m-2">
                Victor Crest
              </span>
              <span className="text-blue-dark">26</span>
            </h1>
          </div>
